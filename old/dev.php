...
<html>
    ...
    <body>
		...
		<div id="container">
			...
			<div id="signature" style="font-size:50px;line-height:60px;"> 
				&nbsp;jsn.crdnl&nbsp;
			</div> 
		...
		<script>
			...
			{
				$("#monSVG .colorizable").each(function(value, index)
				{
					$("#colorInputs").append("<input type='text' class='basicColor' rel='" + $(this).attr("id") + "' />");
				});
